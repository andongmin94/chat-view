async function fetchLatestRelease() {
    try {
      const response = await fetch('https://api.github.com/repos/andongmin94/chat-view/releases/latest', {
  ...
  async function fetchAllReleases() {
    try {
      const response = await fetch('https://api.github.com/repos/andongmin94/chat-view/releases', {
        headers: { 'User-Agent': 'Node.js' }
      });
